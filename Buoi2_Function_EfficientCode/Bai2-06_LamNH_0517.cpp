/* Nguyễn Hoàng Lâm - 0517 - 732833
    ...
    Hãy viết chương trình mô phỏng lại quá trình biến đổi để kiếm chứng giả thuyết với giá trị của n nhập 
    từ bàn phím.*/
#include <stdio.h>
void print(int n){
    printf("n=%d\n", n);
...
void simulate(int n, 
        /*YOUR CODE HERE - Nguyễn Hoàng Lâm - 0517 - 732833*/ int (*odd)(int), int (*even)(int), void (*output)(int) /**/){
    (*output)(n);
    if (n == 1) return;
    if (n % 2 == 0) {
    n = (*even)(n);
